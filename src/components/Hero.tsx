...
import { ArrowRight, Cpu, Sparkles, Zap, Bot, Brain, CircuitBoard, Layers, Network } from 'lucide-react';
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-white pt-24 pb-20 md:pt-32 md:pb-28 min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        ...
        <div className="absolute bottom-32 left-16 w-96 h-96 rounded-full bg-gradient-to-r from-violet-500/20 to-purple-600/20 blur-3xl animate-pulse" style={{animationDelay: '2s'}} />
        <div className="absolute top-1/3 left-1/3 w-64 h-64 rounded-full bg-gradient-to-r from-emerald-500/15 to-teal-500/15 blur-2xl animate-pulse" style={{animationDelay: '4s'}} />
      </div>
      ...
      {/* <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-24 left-1/4 animate-float">
          <div className="relative">
            <div className="absolute inset-0 bg-cyan-500/20 rounded-full blur-lg w-12 h-12"></div>
            <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 p-3 rounded-xl border border-cyan-500/30">
              <Brain className="w-6 h-6 text-cyan-400" />
            </div>
          </div>
        </div>
        
        <div className="absolute top-40 right-1/4 animate-float" style={{animationDelay: '1.5s'}}>
          <div className="relative">
            <div className="absolute inset-0 bg-purple-500/20 rounded-full blur-lg w-12 h-12"></div>
            <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 p-3 rounded-xl border border-purple-500/30">
        ...
        <div className="absolute bottom-40 left-1/3 animate-float" style={{animationDelay: '3s'}}>
          <div className="relative">
            <div className="absolute inset-0 bg-emerald-500/20 rounded-full blur-lg w-12 h-12"></div>
            <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 p-3 rounded-xl border border-emerald-500/30">
              <CircuitBoard className="w-6 h-6 text-emerald-400" />
            </div>
          </div>
        </div>
        
        <div className="absolute bottom-32 right-1/3 animate-float" style={{animationDelay: '0.8s'}}>
          <div className="relative">
            <div className="absolute inset-0 bg-blue-500/20 rounded-full blur-lg w-12 h-12"></div>
            <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 p-3 rounded-xl border border-blue-500/30">
      ...
      <div className="container relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center">
          {/* <div className="inline-flex items-center justify-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/30 to-purple-500/30 rounded-2xl blur-xl w-16 h-16"></div>
              <div className="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-4">
          ...
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-slate-800/60 to-slate-900/60 backdrop-blur-md border border-cyan-500/20 rounded-full px-6 py-3 mb-8">
            ...
            <span className="text-sm font-medium text-slate-300">AI Assistant • Beta Access</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-slate-400 mb-12 leading-relaxed animate-fade-in max-w-3xl mx-auto font-light">
            Experience the future of productivity with an AI assistant that adapts to your workflow,
            <span className="font-medium bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent"> learns your style</span>, 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Automate repetitive tasks while maintaining your unique approach and quality standards.
                  </p>
                </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Continuously learns from your preferences to provide increasingly personalized assistance.
                  </p>
                </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Process complex tasks in seconds, accelerating your workflow without compromising quality.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white to-transparent opacity-100" /> */}
